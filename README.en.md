...
![VSCode Installs](https://img.shields.io/vscode-marketplace/i/roweb.vscode-gerrit.svg?label=VSCode%20Marketplace%20Installs)
...
-   `vscode://roweb.vscode-gerrit?change=12345&checkout` - Checks out a change
-   `vscode://roweb.vscode-gerrit?change=12345&file=index.ts&line=10` - Previews a file in a change without checking it out
-   `vscode://roweb.vscode-gerrit?change=12345&checkout&patchset=2` - Checks out an old patchset of a change
